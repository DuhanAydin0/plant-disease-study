...
from model import CNN_03_Experimental
import config
...
def main():
    ...
    # Paths
    # -----------------------------
    results_dir = Path("experiments/cnn/results/03_optimized")
    results_dir.mkdir(parents=True, exist_ok=True)
    model_save_path = results_dir / "cnn_03_optimized_model.pth"
    ...
    # -----------------------------
    model = CNN_03_Experimental(num_classes=config.NUM_CLASSES).to(device)

...
from model import CNN_04_All_Dataset_Augmentation
import config
...
def main():
    ...
    # Paths
    # -----------------------------
    results_dir = Path("experiments/cnn/results/04_all_dataset_augmentation")
    results_dir.mkdir(parents=True, exist_ok=True)
    model_save_path = results_dir / "cnn_04_all_dataset_augmentation_30epochs_model.pth"
    ...
    # -----------------------------
    model = CNN_04_All_Dataset_Augmentation(num_classes=config.NUM_CLASSES).to(device)
